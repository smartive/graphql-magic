...
export const applyReactionFilters = async (
  ...
  await node.ctx.queryHook?.({ model: node.ctx.models.getModel('Reaction', 'entity'), query, args: normalizedArguments, ctx: node.ctx });
