...
export const applyAnswerFilters = async (
  ...
  await node.ctx.queryHook?.({ model: node.ctx.models.getModel('Answer', 'entity'), query, args: normalizedArguments, ctx: node.ctx });
