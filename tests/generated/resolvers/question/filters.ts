...
export const applyQuestionFilters = async (
  ...
  await node.ctx.queryHook?.({ model: node.ctx.models.getModel('Question', 'entity'), query, args: normalizedArguments, ctx: node.ctx });
